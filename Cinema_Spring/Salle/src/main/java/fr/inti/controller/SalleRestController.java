...
//	public List<Film> addFilmToSalle(@PathVariable Long salleId, @PathVariable Long filmId) {
//        salleService.addFilmToSalle(salleId, filmId);
//        return salleService.findFilmsBySalleId(salleId);
//	}
//	
//	// supprimer un film d'une salle
//	@DeleteMapping("/salle/{salleId}/film/{filmId}")
//	public List<Film> suppFilmToSalle(@PathVariable Long salleId, @PathVariable Long filmId) {
//		salleService.suppFilmToSalle(salleId, filmId);
//		return salleService.findFilmsBySalleId(salleId);
//	}
}
